function LPF_image(inimgname,W1,W2)
% This function performs ideal low-pass filtering in the DFT domain. 
% The user can specify the image name and the DFT window size.
...
% Example: LPF_image('lena.bmp',10,10)
% Yao Wang, 4/2/2003
