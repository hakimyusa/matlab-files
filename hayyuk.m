...
% Last Modified by GUIDE v2.5 19-Oct-2021 23:27:02
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[nama_file,nama_path] = uigetfile({'.jpg';'.bmp';'.png';'.tif';},'Open');
if ~isequal (nama_file,0)
    handles.data1 = imread(fullfile(nama_path,nama_file));
    guidata(hObject,handles);
    axes(handles.axes1);
    imshow(handles.data1);
    info = imfinfo(fullfile(name_path,nama_file));
...
[name_file_save,path_save] = uiputfile( ...
    {'.jpg';'.bmp';'.png';'.tif';},'Save image');
if ~isequal(name_file_save,0)
    imwrite(tresh,fullfile(path_save,name_file_save));
else
    return
end
...
if val1 == 1
    image1 = imrotate(image1,-angle,'bicubic','crop');
elseif val2 == 1
    image1 = imrotate(image1,angle,'bicubic','crop');
end
