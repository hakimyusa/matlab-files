function high_emphasis(inimgname,W1,W2,a)
% This function performs  high emphasis  filtering in the DFT domain. 
% The high-emphasis filter mask is obtained by using (1+a)-a*lowpass mask.
% The user can specify the image name and the DFT window size (for the corresponding 
% lowpass filter) and the high-emphasis weighting coefficient a.
...
% Usage:  LPF_image(inimgname,vertical_window_width,horizontal_window_width)
% inimagename should be typed with a single quotation mark.
% Example: high_emphasis('lena.bmp',50,50,0.1)
% Yao Wang, 4/2/2003
